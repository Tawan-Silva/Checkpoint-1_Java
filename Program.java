...
public class Program {
	...
	public static void main(String[] args) {
		...
		listContas.add(new ContaPoupanca(1001, "Santos", 1000.0, 0.1));
		listContas.add(new ContaPoupanca(1002, "Thially", 500.0, 500.0));
		listContas.add(new ContaPoupanca(1003, "Tawan", 1000.0, 0.1));
		
		listContas.add(new ContaCorrente(1004, "Catia", 1000.0, 500.0));
		listContas.add(new ContaCnpj(1005, "Rose", 2000.0, 500.0));
		listContas.add(new ContaCnpj(1006, "Samara", 500.0, 500.0));
		listContas.add(new ContaCnpj(1007, "Camara", 500.0, 500.0));
		
		listContasCorrente.add(new ContaCorrente(1008, "Silva", 2000.0, 4200.0));
		listContasCorrente.add(new ContaCorrente(1009, "Souza", 100.0, 300.0));
